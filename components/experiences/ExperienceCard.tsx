...
const ExperienceCard: React.FC<ExperienceCardProps> = ({
  ...
  return (
    <div 
      ...
      className="cursor-pointer min-w-[240px] h-[312px]"
    >
      <div className="flex flex-col w-full">
       ...
       <div className="flex flex-col px-4 gap-4 py-3 bg-card ">
        ...
        <div className="flex flex-row justify-between items-center gap-1">
          <div className="font-medium text-heading text-xl leading-4">
           <span className="font-normal text-heading text-xs leading-4">From</span> ${data.price}
          </div>
